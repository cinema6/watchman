...
BeeswaxMiddleware.prototype.reactivateCampaign = function (campaign) {
    ...
    return this.beeswaxApi.campaigns.edit(beeswaxId, {
        ...
        return this.beeswaxApi.lineItems.queryAll({
            campaign_id: beeswaxId,
            active: false
        });
    }).then(result => {
        return Promise.all(result.payload.map(lineItem => {
            return this.beeswaxApi.lineItems.edit(lineItem.line_item_id, {
                active: true
            });
        }));
    });
